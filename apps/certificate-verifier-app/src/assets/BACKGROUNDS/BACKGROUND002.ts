...
<head>
    ...
    <style>
        ...
        .page-background {
            ...
            z-index: -1;
            background: white;
            background-image: url(https://res.cloudinary.com/dkzhem9dj/image/upload/v1747863806/background-certificado-2025-horizontal_sgdcxgrds.png);
    ...
    <div class="bodydiv">
        ...
        <div class="col1">
            <div class="logos-section">
                ...
                <img src="https://res.cloudinary.com/dkzhem9dj/image/upload/v1747947423/blockchain-webpage/Logo-Municipio-Rumi_asufhsdhn.svg" alt="Logo del Municipio de Rumiñahui 2025" class="logo2"/>
            </div>
            <div class="name-participant-section">
                <h1 class="montserrat-bold-text">El Instituto Tecnológico Superior Rumiñahui y el GAD Municipal de Rumiñahui</h1>
                ...
                <div class="signs-section">
                    <div>
                        ...
                        <p style="margin-top: 0cm;font-size: 0.4cm !important;" class="montserrat-text-sign">Ing. Fabián Iza</p>
                        <p style="margin-top: -0.35cm;font-size: 0.35cm !important;" class="montserrat-text-sign"><strong>ALCALDE</strong></p>
                    </div>
...
`
export default html_BACKGROUND002