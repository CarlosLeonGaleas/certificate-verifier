    ...
    <div class="bodydiv">
        <div class="col0">
            ...
            <a href="{{url-tokenid}}" style="text-decoration: none; color: inherit;">
                ...
                margin-left: -3.15cm;background: #ff8300 !important; height: 0.5cm; align-content: center; 
        ...
        <div class="col1">
            <div class="logos-section">
                ...
                <img src="https://res.cloudinary.com/dkzhem9dj/image/upload/v1756905811/LOGO_RIT2_1_gjsbqs.svg" alt="Logo RIT2" class="logo3"/>
            ...
            <div class="name-participant-section">
                <h1 class="montserrat-bold-text">La Red de Investigación, Innovación y Transferencia de Tecnología con el Departamento de Investigación del Instituto Tecnológico Superior Rumiñahui</h1>
        ...
        <div class="col2">
            ...
            <div class="blockchain-banner-section">
                <p class="montserrat-text-banner" 
                style="font-size: 0.24cm;color: white;position: absolute; bottom: 0.1cm; width: 2.5cm;margin-top: 80%;
                margin-left: -2.85cm;background: #ff8300 !important; height: 1.1cm; align-content: center; align-items: center;
                border-radius: 1em; max-width: 3cm;"
                >
...
`
export default html_BACKGROUND006